...
$('#reinvestToggle').qtip({ // Grab some elements to apply the tooltip to
    content: {
        text: 'Allow bots to automatically reinvest your dividends in exchange for a referral bonus. This enables faster compounding, and can be turned off at any time.'
    },
    style: {
        classes: 'info',
    }
