...
if (typeof web3 == 'undefined') {
    alertify.alert(
        "Welcome to P3C, let's get started!", 
        `<h2 style="text-align: center;">Click the image below to install a wallet.</h2>
        <a href="https://forum.saturn.network/t/how-to-setup-an-ethereum-classic-wallet-on-a-mobile-phone-using-trust-wallet/2593" target="_blank">
        <img id="logo" src="img/trust.png" class="mobile only ui image"/>
        </a>
        <a href="https://chrome.google.com/webstore/detail/saturn-wallet/nkddgncdjgjfcddamfgcmfnlhccnimig" target="_blank">
        <img id="logo" src="img/saturn.png" class="saturn custom-computer only ui image"/>
        </a>
        <h2 class="custom-computer only" style="text-align: center;"> Need help? <a target="_blank" href="https://www.youtube.com/watch?v=XEDjtJJH0BE&">Video Tutorial.</a></h2>` 
         , 
        function(){
