        ...
        farmContract.myCrop.call(function (err, result) {
            ...
            if (onboard && (err || (result == '0x0000000000000000000000000000000000000000'))) {
                setTimeout(function (){
                    ...
                    `
                    <p class="agreement">
                    P3C is an autonomous smart contract. Read it <a target="_blank" href="https://etherhub.io/addr/0xde6fb6a5adbe6415cdaf143f8d90eb01883e42ac#tab_addr_3">here</a>. By agreeing, you accept that the contract will be run as written, and that <b>code is law</b>.
