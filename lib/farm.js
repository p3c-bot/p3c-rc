...
function getMyCrop(onboard) {
    farmContract.myCrop.call(function (err, result) {
        ...
        // if we're onboarding, there isnt a web3 err or the result is 0x000 and account isn't made
        if ((onboard == true) && (err || (result == '0x0000000000000000000000000000000000000000')) /*&& (web3.eth.accounts != currentAccount) */) {
            alertify.confirm('Welcome to P3C',
                ...
                To accept you need an <a target="_blank" href="https://chrome.google.com/webstore/detail/saturn-wallet/nkddgncdjgjfcddamfgcmfnlhccnimig">Ethereum Classic Wallet</a> with ETC. ETC can be purcahsed on exchanges like Binance and Coinbase.
                </p>
        ...
        if (!err) {
            localStorage.setItem('account', web3.eth.accounts[0])
