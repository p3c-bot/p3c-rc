        ...
        farmContract.myCrop.call(function (err, result) {
            ...
            if (onboard && (err || (result == '0x0000000000000000000000000000000000000000'))) {
                alertify.confirm(
                    ...
                    `
                    <p class="agreement">
                    P3C is an autonomous smart contract. You can read it <a target="_blank" href="http://etherhub.io/addr/0xae5433263a626f397fed88421cc85ffd22bbc8dd#tab_addr_3">here</a>. By agreeing, you accept that the contract will be run as written and that <b>code is law</b>.
                    To accept you need an <a target="_blank" href="https://chrome.google.com/webstore/detail/saturn-wallet/nkddgncdjgjfcddamfgcmfnlhccnimig">Ethereum Classic Wallet</a> with ETC.
                    </p>
